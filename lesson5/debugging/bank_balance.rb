...
Assignment methods do not return the last evaluated expression or the argument 
passed to an explicit return. They always return the assigned value on the 
